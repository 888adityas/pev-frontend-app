...
const applications = [
  ...
  },
  {
    ...
    tooltip: 'Click here to access Pabbly Connect admin panel.',
  ...
  },
  {
    ...
    tooltip: 'Click here to access Pabbly Subscription Billing admin panel.',
  ...
  },
  {
    ...
    tooltip: 'Click here to access Pabbly Email Marketing admin panel.',
  ...
  },
  {
    ...
    tooltip: 'Click here to access Pabbly Form Builder admin panel.',
...
export default function AdminPabblyAppsMenu() {
  ...
  return (
    <>
      <Tooltip
        title="Easily access all your Pabbly Admin Panels from here."
        arrow
        placement="bottom"
      >
        <IconButton
      ...
      >
        <Box sx={{ display: 'flex', flexDirection: 'column', p: 0 }}>
          ...
          >
            <Box sx={{ px: 2, pb: 1.5 }}>
              <Tooltip
                title=" Search and access any Pabbly Admin Panel instantly."
                arrow
                placement="left"
              >
                <Typography
